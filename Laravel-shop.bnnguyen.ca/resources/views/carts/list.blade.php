                                ...
                                <table class="table-shopping-cart">
                                    ...
                                    @foreach($products as $key => $product)
                                        ...
                                        <tr class="table_row">
                                            ...
                                            <td class="column-5">${{ number_format($priceEnd, 2, '.', '.') }}</td>
                                            <td class="p-r-15">
                                                <a href="/carts/delete/{{ $product->id }}">Remove</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                        ...
                        <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                            ...
                            <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                                ...
                                <div class="size-100 p-r-18 p-r-0-sm w-full-ssm">
                                    ...
                                    <div class="p-t-15">
                                        <span class="stext-112 cl8">Customer information:</span>
                                        ...
                                        <div class="bor8 bg0 m-b-12">
                                            <textarea class="cl8 plh3 size-111 p-lr-15" name="content" required></textarea>
                                        </div>
