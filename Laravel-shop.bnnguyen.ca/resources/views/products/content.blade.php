...
@section('content')
    <div class="container p-t-80">
        <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
            ...
            <a href="/products/?cat={{ $product->menu->id }}&t={{ Str::slug($product->menu->name) }}.html"
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <div class="flex-w flex-m p-l-100 p-t-40 respon7">
                            <a href="https://www.facebook.com/share.php?u={{ request()->url() }}" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 m-r-8 tooltip100" target="_blank"
                               data-tooltip="Facebook">
                                <i class="fa fa-facebook"></i>
                            </a>

                            <a href="https://twitter.com/intent/tweet?url={{ request()->url() }}&text=" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 m-r-8 tooltip100"
                               data-tooltip="Twitter" target="_blank">
